...
/**
 * Promoters choose which suggestions to promote from all the available
 * suggestions.
 * 
 */
public interface Promoter
{
	 ...
	 * 
	 * @param shortcuts
	 *            The shortcuts for the query.
	 * @param suggestions
	 *            The suggestions from each source.
	 * @param maxPromoted
	 *            The maximum number of suggestions to promote.
	 * @param promoted
	 *            List to add the promoted suggestions to.
	 */
