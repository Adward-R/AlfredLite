...
{
	/**
	 * Gets the number of distinct suggestion view types created by this
	 * factory.
	 */
	 ...
	 * @param convertView
	 *            A view which may be re-used, or {@code null}.
	 * @param parentViewType
	 *            Used to create LayoutParams of the right type.
	 */
	SuggestionView getSuggestionView(int viewType, View convertView,
