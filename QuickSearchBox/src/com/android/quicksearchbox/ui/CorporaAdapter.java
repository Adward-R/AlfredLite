...
public class CorporaAdapter extends BaseAdapter
{
	...
	private CorporaAdapter(CorpusViewFactory viewFactory, CorpusRanker ranker,
			boolean gridView)
	{
	...
	public static CorporaAdapter createListAdapter(
			CorpusViewFactory viewFactory, CorpusRanker ranker)
	{
		return new CorporaAdapter(viewFactory, ranker, false);
	}

	public static CorporaAdapter createGridAdapter(
			CorpusViewFactory viewFactory, CorpusRanker ranker)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (DBG)
			Log.d(TAG, "Binding " + position + ", label=" + label);
		view.setIcon(icon);
		view.setLabel(label);
		return view;
	}
