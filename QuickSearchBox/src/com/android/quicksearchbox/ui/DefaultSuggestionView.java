...
/**
 * View for the items in the suggestions list. This includes promoted
 * suggestions, sources, and suggestions under each source.
 * 
 */
public class DefaultSuggestionView extends RelativeLayout implements
		SuggestionView
{
	...
	private CharSequence formatUrl(CharSequence url)
	{
		...
		ColorStateList colors = getResources().getColorStateList(
				R.color.url_text);
		text.setSpan(new TextAppearanceSpan(null, 0, 0, colors, null), 0, url
