...
public abstract class MultiSourceCorpus extends AbstractCorpus
{
	...
	public MultiSourceCorpus(Context context, Executor executor,
			Source... sources)
	{
		mContext = context;
		mExecutor = executor;
	...
	/**
	 * Creates a corpus result object for a set of source results. This method
	 * should not call {@link Result#fill}.
	 * 
	 * @param query
	 *            The query text.
	 * @param results
	 ...
	 * @param latency
	 *            Latency in milliseconds of the suggestion queries.
	 * @return An instance of {@link Result} or a subclass of it.
	 */
	protected Result createResult(String query,
			ArrayList<SourceResult> results, int latency)
	{
	...
	public CorpusResult getSuggestions(String query, int queryLimit)
	{
		...
		BarrierConsumer<SourceResult> consumer = new BarrierConsumer<SourceResult>(
				sources.size());
		for (Source source : sources)
		{
			QueryTask<SourceResult> task = new QueryTask<SourceResult>(query,
					queryLimit, source, null, consumer);
	...
	/**
	 * Base class for results returned by
	 * {@link MultiSourceCorpus#getSuggestions}. Subclasses of
	 * {@link MultiSourceCorpus} should override
	 * {@link MultiSourceCorpus#createResult} and return an instance of this
	 * class or a subclass.
	 */
	protected class Result extends ListSuggestionCursor implements CorpusResult
	{
		...
		/**
		 * Fills the list of suggestions using the list of results. The default
		 * implementation concatenates the results.
		 */
		public void fill()
		{
