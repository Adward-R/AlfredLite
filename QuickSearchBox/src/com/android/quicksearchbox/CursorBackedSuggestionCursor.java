...
public abstract class CursorBackedSuggestionCursor extends
		AbstractSuggestionCursor
{
	...
	/**
	 * Column index of {@link SearchManager#SUGGEST_COLUMN_FORMAT} in @{link
	 * mCursor}.
	 */
	private final int				mFormatCol;
	/**
	 * Column index of {@link SearchManager#SUGGEST_COLUMN_TEXT_1} in @{link
	 * mCursor}.
	 */
	private final int				mText1Col;
	/**
	 * Column index of {@link SearchManager#SUGGEST_COLUMN_TEXT_2} in @{link
	 * mCursor}.
	 */
	private final int				mText2Col;
	/**
	 * Column index of {@link SearchManager#SUGGEST_COLUMN_TEXT_2_URL} in @{link
	 * mCursor}.
	 */
	private final int				mText2UrlCol;
	/**
	 * Column index of {@link SearchManager#SUGGEST_COLUMN_ICON_1} in @{link
	 * mCursor}.
	 */
	...
	/**
	 * Column index of
	 * {@link SearchManager#SUGGEST_COLUMN_SPINNER_WHILE_REFRESHING} in @{link
	 * mCursor}.
	 **/
	...
	public void moveTo(int pos)
	{
		...
		try
		{
			...
			{
				Log.e(TAG, "moveToPosition(" + pos + ") failed, count="
						+ getCount());
			}
		}
		catch (RuntimeException ex)
