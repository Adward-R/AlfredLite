...
public final class Unicode2Alpha {
	...
	/**
	 * 判断源字符串是否可表达为指定的首字母序列表达形式。支持多音字检测。
	 * @param source	源字符串
	 * @param alphaseq	首字母序列
	 * @return	是否可用指定首字母序列表达
	 */
	public static boolean checkAlpha(String source, String alphaseq) {
		...
		for (int i = 0; i < alphaseq.length(); i++) {
			...
			if (multi == null) {
				if (zh2alpha.charAt(code - ZH_START) != alphaseq_lower.charAt(i) && jp2alpha.charAt(code - JP_START) != alphaseq_lower.charAt(i)) return false;
			} else {
